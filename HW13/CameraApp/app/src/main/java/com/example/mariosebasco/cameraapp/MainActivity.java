package com.example.mariosebasco.cameraapp;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    private void getThreshold() {
        ...
        myControl.setOnSeekBarChangeListener(new android.widget.SeekBar.OnSeekBarChangeListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myControl = (SeekBar) findViewById(R.id.seek1); //find and instantiate the seekbar
